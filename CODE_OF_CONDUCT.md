...
We as members, contributors, and leaders of the **EDA-Schema** project,
maintained by the Drexel University Integrated Circuits and Electronics (ICE)
Laboratory, pledge to make participation in our community a harassment-free
...
* Focusing on what is best not just for us as individuals, but for the overall
  community
* Citing and crediting prior work, datasets, and contributors
...
* Submitting plagiarized code, datasets, or research without attribution
...
GitHub repository, Issues, Pull Requests, Discussions, mailing lists, and any
official communication channel — and also applies when an individual is
...
at an online or offline event, including academic conferences and workshops.
